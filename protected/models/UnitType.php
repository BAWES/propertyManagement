 ...
 * @property Unit[] $units
 * @property UnitTypeQuestion[] $unitTypeQuestions
 */
class UnitType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'units' => array(self::HAS_MANY, 'Unit', 'unit_type_id'),
			'unitTypeQuestions' => array(self::HAS_MANY, 'UnitTypeQuestion', 'unit_type_id'),
		);
	}
