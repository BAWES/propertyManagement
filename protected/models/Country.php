...
class Country extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('country_name_en, country_name_ar', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('country_id, country_name_en, country_name_ar', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'owners' => array(self::HAS_MANY, 'Owner', 'country_id'),
			'tenants' => array(self::HAS_MANY, 'Tenant', 'country_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('country_name_ar',$this->country_name_ar,true);
