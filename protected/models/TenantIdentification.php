...
/**
 * This is the model class for table "tenant_identification".
 *
 * The followings are the available columns in table 'tenant_identification':
 ...
 */
class TenantIdentification extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('tenant_id, identifytype_id', 'required'),
			array('tenant_id, identifytype_id', 'length', 'max'=>11),
			array('identify_number', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('identify_id, tenant_id, identifytype_id, identify_number', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TenantIdentification the static model class
	 */
